...
<body>
                                ...
                                <div class="form-group row">
                                    <div class="col-12">
                                        <div class="form-material floating">
                                            <input type="email" class="form-control" id="correo" name="correo" required onpaste="return false;" onkeypress="return event.charCode != 60 && event.charCode != 62 && event.charCode != 32 && event.charCode != 34;">
    ...
    <script src="resetBack/recuperar_Contraseña.js"></script>
</body>
</html>
