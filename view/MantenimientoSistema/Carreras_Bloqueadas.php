...
?>
    ...
    <body>
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <div class="content">
                <div class="block">
                    <div class="block-header block-header-default">
                        <h3 class="block-title">Gestión de Carreras Bloqueadas</h3>
                    ...
                    <div class="block-content block-content-full">
                        ...
                        <td class="text-center">
                            <a href="Carreras.php">
                                <button type="button" class="btn btn-sm btn-secondary" title="Carreras Habilitadas">
                        ...
                        <table class="table table-bordered table-striped table-vcenter">
                            <thead>
                                <tr>
                                    ...
                                    <th class="text-center" style="width: 15%;">HABILITAR CARRERA</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php
                            ...
                            ORDER BY c.IdCarrera";
                                ...
                                if ($result !== false && $result->rowCount() > 0) {
                                    ...
                                    <button type='button' class='btn btn-sm btn-success' data-toggle='modal' data-target='#confirmEnableCarreraModal' 
            ...
            <!-- Modal para confirmar habilitación de Carrera -->
            <div class="modal fade" id="confirmEnableCarreraModal" tabindex="-1" role="dialog" aria-labelledby="confirmEnableCarreraModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="confirmEnableCarreraModalLabel">Habilitar Carrera</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <p>¿Estás seguro de que quieres habilitar esta carrera?</p>
                            <form id="enableCarreraForm" method="POST" action="../MantenimientoSistema/Carreras/Habilitar_Carrera.php">
                                <input type="hidden" id="enable_IdCarrera" name="IdCarrera">
            ...
            <script>
                // JavaScript para pasar el IdCarrera al formulario
                $('#confirmEnableCarreraModal').on('show.bs.modal', function(event) {
                    var button = $(event.relatedTarget); // Botón que abrió el modal
                    var IdCarrera = button.data('id'); // Extraer el ID de Carrera
                    var modal = $(this);
                    modal.find('.modal-body #enable_IdCarrera').val(IdCarrera); // Establecer el valor en el campo oculto
                });
            </script>
            ...
            <script>
                ...
                function handleURLParams() {
                    ...
                    if (urlParams.has('mensaje')) {
                        ...
                        switch (mensaje) {
                            case 'habilitada':
                                showAlert('La carrera ha sido habilitada exitosamente.', 'success');
                                break;
                            case 'error':
                                showAlert('Hubo un error al habilitar la carrera. Intenta nuevamente.', 'error');
                                break;
                            default:
                                break;
                        }
