...
if (isset($_SESSION["IdUsuario"])) {
    ...
    $id_objeto = 35; // ID del objeto o módulo correspondiente a esta página
            ...
            <div class="content">
                ...
                <div class="row justify-content-center">
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AcuerdoApro_Agenda.php" data-id-objeto="43" data-accion="accedio al modulo" class="modulo-link block block-link-shadow text-center">
                    ...
                    <div class="col-md-4" data-toggle="appear">
                        <a href="../MantenimientoSolicitudes/AcuerdoApro_Asignar.php" data-id-objeto="44" data-accion="accedio al modulo" class="modulo-link block block-link-shadow text-center">
                            <div class="block-content block-content-full">
                                <div class="py-30 text-center">
