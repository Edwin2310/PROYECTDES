...
//boton rachazo DE
document.getElementById('btn-rechazar-DE').addEventListener('click', function () {
    ...
    formData.append('nuevoEstado', 25); // Establecer el nuevo estado a 18
...
//boton aprobado
document.getElementById('btn-aprobado-DE').addEventListener('click', function () {
    var idSolicitud = new URLSearchParams(window.location.search).get('id');

    // Crear un nuevo objeto FormData para la solicitud
    var formData = new FormData();
    formData.append('idSolicitud', idSolicitud);
    formData.append('nuevoEstado', 22); // Establecer el nuevo estado a 20
