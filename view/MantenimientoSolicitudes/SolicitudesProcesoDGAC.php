...
if ($id) {
    ...
    try {
        ...
        $sql = "CALL `proceso.splObtenerSolicitudesAEvaluar`(:id)";
                            ...
                            <div class="block-content block-content-sm block-content-full bg-body-light">
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <button type="button" class="btn btn-alt-warning" id="btn-rechazar">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-6 text-right">
                                        <button type="button" class="btn btn-alt-primary" id="btn-aprobado">
