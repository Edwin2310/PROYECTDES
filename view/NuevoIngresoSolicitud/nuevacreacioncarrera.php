    ...
    <body>
        ...
        <div id="page-container" class="sidebar-o side-scroll page-header-modern main-content-boxed">
            ...
            <main id="main-container">
                <div class="content">
                    <h2 class="content-heading">Creación de carrera <small>Dirección de Educación Superior</small></h2>
                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="block-content block-content-sm block-content-full bg-body-light">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label class="col-12" for="Universidad">Universidad/Centro/Institucion</label>
                                                            <div class="col-12">
