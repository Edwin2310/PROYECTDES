                        ...
                        <div class="content content-full">
                            <div class="py-30 text-center">
                                <div class="display-3 text-danger">
                                    <i class="fa fa-warning"></i> ACCESO DENEGADO
                                </div>
                                <h1 class="h2 font-w700 mt-30 mb-10">Ups... Acabas de encontrar una página de error.</h1>
                                <h2 class="h3 font-w400 text-muted mb-50">Lo sentimos pero no tienes los permisos necesarios para acceder a esta página..</h2>
                                <a class="btn btn-hero btn-rounded btn-alt-secondary" href="javascript:history.back()">
                                    <i class="fa fa-arrow-left mr-10"></i> Volver atrás
                                </a>
                            </div>
                        </div>
                    </div>
...
<script>
    // Marcar la visita a la página de acceso denegado
    sessionStorage.setItem('denegadoVisitado', 'true');
</script>